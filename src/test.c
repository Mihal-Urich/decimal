...
s21_decimal_suite(void) {
  ...
  tcase_add_test(tcase_core, s21_from_decimal_to_float_6);
  tcase_add_test(tcase_core, s21_from_decimal_to_float_7);
  tcase_add_test(tcase_core, s21_from_decimal_to_float_8);
  tcase_add_test(tcase_core, s21_from_decimal_to_float_9);
  tcase_add_test(tcase_core, s21_from_decimal_to_float_10);
  tcase_add_test(tcase_core, s21_from_decimal_to_float_11);
  tcase_add_test(tcase_core, s21_from_decimal_to_float_12);
  tcase_add_test(tcase_core, s21_from_decimal_to_float_13);
  tcase_add_test(tcase_core, s21_from_decimal_to_float_14);

  // Из float во s21_decimal
  tcase_add_test(tcase_core, s21_from_float_to_decimal_0);
  ...
  tcase_add_test(tcase_core, s21_from_float_to_decimal_11);
  tcase_add_test(tcase_core, s21_from_float_to_decimal_12);
  tcase_add_test(tcase_core, s21_from_float_to_decimal_13);
